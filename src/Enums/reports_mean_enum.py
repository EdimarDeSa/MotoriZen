...
class ReportsMeanEnum(StrEnum):
    ...
    MEAN_COMSUPTION_PER_TRIP = "MEAN_COMSUPTION_PER_TRIP"
    MEAN_COMSUPTION_PER_DISTANCE = "MEAN_COMSUPTION_PER_DISTANCE"
    MEAN_COMSUPTION_PER_WORKING_HOUR = "MEAN_COMSUPTION_PER_WORKING_HOUR"
    MEAN_COMSUPTION_PER_WORKING_MINUTE = "MEAN_COMSUPTION_PER_WORKING_MINUTE"

    MEAN_VALUE_RECEIVED = "MEAN_VALUE_RECEIVED"
    MEAN_VALUE_RECEIVED_PER_TRIP = "MEAN_VALUE_RECEIVED_PER_TRIP"
    MEAN_VALUE_RECEIVED_PER_COMSUPTION = "MEAN_VALUE_RECEIVED_PER_COMSUPTION"
