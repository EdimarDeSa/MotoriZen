...
class ReportsEnum(StrEnum):
    ...
    ### Consumption reports ###
    MEAN_CONSUPTION_PER_DISTANCE = "MEAN_CONSUPTION_PER_DISTANCE"
    MEAN_CONSUPTION_PER_TRIP = "MEAN_CONSUPTION_PER_TRIP"
    MEAN_CONSUPTION_PER_WORKING_HOUR = "MEAN_CONSUPTION_PER_WORKING_HOUR"
    MEAN_CONSUPTION_PER_WORKING_MINUTE = "MEAN_CONSUPTION_PER_WORKING_MINUTE"
    TOTAL_CONSUPTION = "TOTAL_CONSUMPTION"
